...
//  Whatsup
//
//  Created by Salome Vizcarra on 03/02/26.
//
...
#Preview {
    ChatMessageView(chatMessage: ChatMessage(documentId: "ABCD", text: "Hello World", uid: "QWERTY", dateCreated: Date(), displayName: "SalomeViz"), direction: .right, color: .blue)
}
