...
extension ChatMessage {
    ...
    static func fromSnapshot(snapshot: QueryDocumentSnapshot) -> ChatMessage? {
        ...
        return ChatMessage(documentId: snapshot.documentID, text: text, uid: uid, displayName: displayName, profilePhotoURL: profilePhotoURL, attachmentPhotoURL: attachmentPhotoURL)
    }
}
